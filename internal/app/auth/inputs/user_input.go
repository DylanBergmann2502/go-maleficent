...
type ListUsersInput struct {
	...
	CreatedAtGTE time.Time `query:"created_at__gte" format:"date-time" doc:"Filter users created at or after this timestamp"`
	CreatedAtLTE time.Time `query:"created_at__lte" format:"date-time" doc:"Filter users created at or before this timestamp"`
	UpdatedAtGTE time.Time `query:"updated_at__gte" format:"date-time" doc:"Filter users updated at or after this timestamp"`
	UpdatedAtLTE time.Time `query:"updated_at__lte" format:"date-time" doc:"Filter users updated at or before this timestamp"`
}
